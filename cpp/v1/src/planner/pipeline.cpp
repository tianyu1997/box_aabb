// SafeBoxForest — pipeline convenience functions
...
SBFConfig make_panda_config(int seed) {
    ...
    cfg.ffb_min_edge_anchor = 0.001;   // aggressive for start/goal anchors
    cfg.ffb_min_edge_relaxed = 0.05;   // relaxed after connectivity established
