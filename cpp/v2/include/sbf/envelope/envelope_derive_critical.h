// SafeBoxForest v2 — Critical-Point Envelope Derive
// Module: sbf::envelope
//
...
// per-frame position intervals [x_lo, y_lo, z_lo, x_hi, y_hi, z_hi].
//
...
//
// out_frames: [n_frames × 6] floats   (n_frames = n_joints + has_tool)
...
//                         Companion matrix eigenvalue solver (all real roots)
...
struct AnalyticalCriticalConfig {
    ...
    //   - Phase 2.5b: one additional free joint m  → 2-DOF companion solve
