"""
examples/viz_compare_expansion.py — 4 模式扩展对比可视化
...
用法:
    cd safeboxforest/v3
    python examples/viz_compare_expansion.py [--seed 42] [--max-boxes 200]
"""
...
from viz_2d_forest_grower import (
    GrowVizConfig, CSpace2D, ForestGrower2D,
    build_random_scene, ROOT_COLORS, compose_gif,
...
def main():
    ...
    parser.add_argument("--snap-every", type=int, default=5)
    ...
    cfgs = [
        ...
        make_cfg(mode="wavefront", adaptive_min_edge=True,
                 coarse_min_edge=0.15, coarse_fraction=0.5),                # ④ 自适应
    ]
    labels = [
        "Wavefront (1T)",
        "RRT (1T)",
