// SafeBoxForest v3 — Envelope Derive: frames / endpoint_aabbs → AABB / subdivided AABB / grid
// Module: sbf::envelope
//
...
//   All AABB sources (IFK, CritSample, AnalyticalCrit, GCPC) produce a common
//   intermediate: endpoint_aabb [n_active × (n_ep+1) × 6] — geometry-only
//   per-link AABBs at each interpolation point.  The envelope layer derives
//   SubAABB, SubAABB_Grid, or Hull16_Grid from endpoint_aabbs, with
//   link radius applied during sub-AABB union + inflation.
//
