...
//  hull_rasteriser.cpp
//
//  Implementation of robot envelope → VoxelGrid rasterisation.
//  迁移自 v3 hull_rasteriser.cpp
// ═══════════════════════════════════════════════════════════════════════════
...
{
    PosInterval p;
    // Position is in columns [3],[7],[11] of the 4×4 prefix transform (row-major)
...
{
    float aabb[6] = {
        static_cast<float>(cx - hx),
        static_cast<float>(cy - hy),
        static_cast<float>(cz - hz),
        static_cast<float>(cx + hx),
        static_cast<float>(cy + hy),
        static_cast<float>(cz + hz)
    };
