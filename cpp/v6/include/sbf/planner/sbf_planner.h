...
/// @brief Per-phase timing breakdown from build_coverage().
struct BuildTimingProfile {
    ...
    int64_t v6_cache_ep_probe_calls = 0;
    int64_t v6_cache_ep_probe_slots = 0;
    int64_t v6_cache_ep_probe_max = 0;
    int64_t v6_cache_ep_lookup_bytes = 0;
    int64_t v6_cache_ep_insert_bytes = 0;
    int64_t v6_cache_ep_grow_calls = 0;
    int64_t v6_cache_ep_grow_ns = 0;
    int64_t v6_cache_grid_mem_hits = 0;
    int64_t v6_cache_grid_mem_misses = 0;
    int64_t v6_cache_grid_disk_hits = 0;
    int64_t v6_cache_grid_disk_misses = 0;
    int64_t v6_cache_grid_pread_calls = 0;
    int64_t v6_cache_grid_pread_bytes = 0;
    int64_t v6_cache_grid_pread_ns = 0;
    int64_t v6_cache_grid_pwrite_calls = 0;
    int64_t v6_cache_grid_pwrite_bytes = 0;
    int64_t v6_cache_grid_insert_ns = 0;
    int64_t v6_cache_grid_grow_calls = 0;
    int64_t v6_cache_grid_grow_ns = 0;
    int64_t v6_cache_grid_dead_bytes = 0;
...
private:
    ...
    BuildTimingProfile last_build_timing_;
