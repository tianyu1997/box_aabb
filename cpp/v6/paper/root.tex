...
convex relaxation, and \texttt{randomForwardPathSearch} rounding
(10 paths, 100 trials), matching the original implementation.

\input{generated/tab4_baselines}

\input{generated/tab5_per_query}

Table~\ref{tab:baselines} reveals three findings:
\begin{enumerate}
  \item \textbf{All four methods achieve 100\% success rate,}
    confirming that each approach provides sufficient
    coverage of the 7-DOF combined scene.
  ...
  \item \textbf{SBF offers the best precomputation--query trade-off.}
