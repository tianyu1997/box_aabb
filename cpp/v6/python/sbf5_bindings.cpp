...
PYBIND11_MODULE(_sbf6_cpp, m) {
    ...
    py::class_<sbf::BuildTimingProfile>(m, "BuildTimingProfile")
        ...
        .def_readonly("v6_cache_ep_probe_calls", &sbf::BuildTimingProfile::v6_cache_ep_probe_calls)
        .def_readonly("v6_cache_ep_probe_slots", &sbf::BuildTimingProfile::v6_cache_ep_probe_slots)
        .def_readonly("v6_cache_ep_probe_max", &sbf::BuildTimingProfile::v6_cache_ep_probe_max)
        .def_readonly("v6_cache_ep_lookup_bytes", &sbf::BuildTimingProfile::v6_cache_ep_lookup_bytes)
        .def_readonly("v6_cache_ep_insert_bytes", &sbf::BuildTimingProfile::v6_cache_ep_insert_bytes)
        .def_readonly("v6_cache_ep_grow_calls", &sbf::BuildTimingProfile::v6_cache_ep_grow_calls)
        .def_readonly("v6_cache_ep_grow_ns", &sbf::BuildTimingProfile::v6_cache_ep_grow_ns)
        .def_readonly("v6_cache_grid_mem_hits", &sbf::BuildTimingProfile::v6_cache_grid_mem_hits)
        .def_readonly("v6_cache_grid_mem_misses", &sbf::BuildTimingProfile::v6_cache_grid_mem_misses)
        .def_readonly("v6_cache_grid_disk_hits", &sbf::BuildTimingProfile::v6_cache_grid_disk_hits)
        .def_readonly("v6_cache_grid_disk_misses", &sbf::BuildTimingProfile::v6_cache_grid_disk_misses)
        .def_readonly("v6_cache_grid_pread_calls", &sbf::BuildTimingProfile::v6_cache_grid_pread_calls)
        .def_readonly("v6_cache_grid_pread_bytes", &sbf::BuildTimingProfile::v6_cache_grid_pread_bytes)
        .def_readonly("v6_cache_grid_pread_ns", &sbf::BuildTimingProfile::v6_cache_grid_pread_ns)
        .def_readonly("v6_cache_grid_pwrite_calls", &sbf::BuildTimingProfile::v6_cache_grid_pwrite_calls)
        .def_readonly("v6_cache_grid_pwrite_bytes", &sbf::BuildTimingProfile::v6_cache_grid_pwrite_bytes)
        .def_readonly("v6_cache_grid_insert_ns", &sbf::BuildTimingProfile::v6_cache_grid_insert_ns)
        .def_readonly("v6_cache_grid_grow_calls", &sbf::BuildTimingProfile::v6_cache_grid_grow_calls)
        .def_readonly("v6_cache_grid_grow_ns", &sbf::BuildTimingProfile::v6_cache_grid_grow_ns)
        .def_readonly("v6_cache_grid_dead_bytes", &sbf::BuildTimingProfile::v6_cache_grid_dead_bytes)
