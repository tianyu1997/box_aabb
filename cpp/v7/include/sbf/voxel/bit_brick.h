#pragma once
/// @file bit_brick.h
/// @brief BitBrick: 8x8x8 = 512-voxel occupancy mask packed in 64 bytes.
///
/// Direct port of v6 `sbf::voxel::BitBrick`.
...
struct BrickCoord {
    ...
    bool operator!=(const BrickCoord& o) const noexcept { return !(*this == o); }
};
