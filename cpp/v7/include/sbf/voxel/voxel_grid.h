#pragma once
/// @file voxel_grid.h
/// @brief Sparse voxel grid (FlatBrickMap + Hull-16 turbo scanline).
///
/// Direct port of v6 `sbf::voxel::SparseVoxelGrid`. Header-only, namespace-only
/// change. See cpp/v6/include/sbf/voxel/voxel_grid.h for design rationale.
...
public:
    ...
    struct Entry      { const BrickCoord& key; BitBrick&       value; };
    struct ConstEntry { const BrickCoord& key; const BitBrick& value; };
