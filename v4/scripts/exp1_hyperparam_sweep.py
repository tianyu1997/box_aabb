...
SWEEP_PARAMS = {
    'ffb_min_edge':        [0.02, 0.04, 0.06, 0.08],
    'max_boxes':           [300, 500, 800],
    'max_consecutive_miss': [10, 20, 50],
    'guided_sample_ratio': [0.3, 0.6, 0.9],
}
...
def main():
    ...
    combos = generate_param_combos(SWEEP_PARAMS)
    n_combos = len(combos)
